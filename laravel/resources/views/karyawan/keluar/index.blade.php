        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <div class="card-tools">
                    <a href="/karyawan/keluar/add" class="btn btn-info text-right">Tambah Barang Keluar</a>
                    {{-- <a href="/karyawan/exportpdfkeluar" class="btn btn-info text-right ">Cetak PDF</a> --}}
                </div>
            </div>
        </div>
    </div>
