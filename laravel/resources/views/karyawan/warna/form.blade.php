...
<body class="cbp-spmenu-push">
	<div class="main-content">
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					{{-- <h3 class="title1">Warna Barang</h3> --}}
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Form Warna:</h4>
						</div>
						<div class="form-body">
							<form action="{{ url('/karyawan/warna/createwarna/') }}" role="form" method="POST">
                                @csrf 
                                    <div class="form-group"> 
                                        <label for="warna" >Warna</label> 
                                        <input min="0" name="warna" type="text" class="form-control" id="warna" placeholder="Masukan Warna"> 
                                    </div> 
