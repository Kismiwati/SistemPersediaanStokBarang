                        ...
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <div class="card-tools">
                                    <a href="/admin/masuk/add" class="btn btn-info text-right">Tambah Barang<i
                                            class="fas fa-plus-square"></i></a>
                                    <a href="/admin/cetakMasuk" class="btn btn-info text-right ">Cetak PDF<i
                                            class="fas fa-plus-square"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($datamsk as $m)
                                <tr>
                                    ...
                                    <td>@currency($m->barang->harga)</td>
                                    <td>@currency($m->barang->harga*$m->jml_brg_masuk)</td>
                                    <td>{{ date_format($m->created_at,"Y-m-d ") }}</td>
                                    <td>
                                        <a href="/admin/editBarangmasuk/{{ $m->id }}"
